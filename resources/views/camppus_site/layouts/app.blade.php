...
<link rel='stylesheet' href='{{asset('camppus_assets/plugins/goodlayers-core/plugins/combine/style.css')}}' type='text/css' media='all' />
<link rel='stylesheet' href='{{asset('camppus_assets/plugins/goodlayers-core/include/css/page-builder.css')}}' type='text/css' media='all' />
<link rel='stylesheet' href='{{asset('camppus_assets/plugins/revslider/public/assets/css/settings.css')}}' type='text/css' media='all' />
<link rel='stylesheet' href='{{asset('camppus_assets/css/style-core.css')}}' type='text/css' media='all' />
<link rel='stylesheet' href='{{asset('camppus_assets/css/kingster-style-custom.css')}}' type='text/css' media='all' />
        ...
        <div class="kingster-mobile-header-container kingster-container clearfix">
            <div class="kingster-item-pdlr">
                <div class="kingster-logo-inner">
                    <a class="logo-size" href="{{url('site/')}}">
                        <img src="{{asset('camppus_assets\images\logo.png')}}" alt="Camppus Logo"/>
                        Camppus
                    </a>
                </div>
            </div>
                    ...
                    <div class="kingster-mm-menu-wrap kingster-navigation-font" id="kingster-mobile-menu" data-slide="right">
                        <ul id="menu-main-navigation" class="m-menu">
                            ...
                            <li class="menu-item menu-item-has-children"><a href="#">Pages</a>
                                <ul class="sub-menu">
                                    <li class="menu-item"><a href="{{url('site/aboutus  ')}}">About US</a></li>
                                    ...
                                    <li class="menu-item menu-item-has-children"><a href="{{url('site/contact')}}">Contact</a>
                                            ...
                                            <li class="menu-item menu-item-has-children"><a>Portfolio Masonry</a>
                                                <ul class="sub-menu">
                                                    ...
                                                    <li class="menu-item"><a href="portfolio-masonry-2-columns.html">Masonry 2
                                                            Columns</a></li>
                                                    <li class="menu-item"><a href="portfolio-masonry-4-columns-no-space.html">Masonry
                                                            4 Columns No Space</a></li>
                                                    <li class="menu-item"><a href="portfolio-masonry-3-columns-no-space.html">Masonry
                                                            3 Columns No Space</a></li>
                                                    <li class="menu-item"><a href="portfolio-masonry-2-columns-no-space.html">Masonry
                                    ...
                                    <li class="menu-item"><a href="{{url('site/gallery  ')}}">Gallery</a></li>
                                    {{-- <li class="menu-item"><a href="price-table.html">Price Table</a></li> --}}
                                    {{-- <li class="menu-item"><a href="maintenance.html">Maintenance</a></li> --}}
                                    <li class="menu-item"><a href="{{url('site/coming_soon')}}">Coming Soon</a></li>
                            ...
                            {{-- <li class="menu-item menu-item-has-children"><a href="bachelor-of-science-in-business-administration.html">Academics</a>
                                <ul class="sub-menu">
                                    <li class="menu-item menu-item-has-children"><a>Undergraduate</a>
                                        <ul class="sub-menu">
                                            <li class="menu-item"><a href="bachelor-of-science-in-business-administration.html">Business
                                                    Administration</a></li>
                                    ...
                                    <li class="menu-item menu-item-has-children"><a href="#">Resources</a>
                                        <ul class="sub-menu">
                                            <li class="menu-item"><a href="bachelor-of-science-in-business-administration.html">Department
                                                    Page</a></li>
                            ...
                            <li class="menu-item menu-item-has-children"><a href="apply-to-kingster.html">Admissions</a>
                                <ul class="sub-menu">
                                    {{-- <li class="menu-item"><a href="apply-to-kingster.html">Apply To Camppus</a>
                                    </li> --}}
                                    <li class="menu-item"><a href="{{url('site/camppus_tour')}}">Campus Tour</a></li>
                            ...
                            <li class="menu-item menu-item-has-children"><a href="#">Courses</a>
                                <ul class="sub-menu">
                                    <li class="menu-item"><a href="{{url('site/course_list')}}">Course List </a></li>
                                    <li class="menu-item"><a href="{{url('site/course_list1')}}">Course List </a></li>
                                </ul>
                            </li>
                            {{-- <li class="menu-item"><a href="athletics.html">Athletics</a></li> --}}
                            <li class="menu-item"><a href="{{url('site/')}}">University Life</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="kingster-top-bar">
        ...
        <div class="kingster-top-bar-container kingster-container ">
            <div class="kingster-top-bar-container-inner clearfix">
                <div class="kingster-top-bar-left kingster-item-pdlr"><i class="fa fa-envelope-open-o" id="i_fd84_0"></i> contact@KUTheme.edu <i class="fa fa-phone" id="i_fd84_1"></i> +1-3435-2356-222
                </div>
    ...
    <div class="kingster-header-container  kingster-container">
        <div class="kingster-header-container-inner clearfix">
            <div class="kingster-logo kingster-item-pdlr">
                <div class="kingster-logo-inner">
                    <a class="logo-size logo" href="{{url('site/')}}">
                        <img src="{{asset('camppus_assets/images/logo.png')}}" alt="" />
                    </a>
                    <span class="fa-2x font-weight-bold">CAMPPUS</span>
                </div>
            </div>
                ...
                <div class="kingster-main-menu" id="kingster-main-menu">
                    <ul id="menu-main-navigation-1" class="sf-menu">
                        <li class="menu-item menu-item-home current-menu-item menu-item-has-children kingster-normal-menu">
                            <a href="{{url('site/')}}" class="sf-with-ul-pre">Home</a>
                            {{-- <ul class="sub-menu">
                        ...
                        <li class="menu-item menu-item-has-children kingster-normal-menu"><a href="#" class="sf-with-ul-pre">Pages</a>
                            <ul class="sub-menu">
                                <li class="menu-item" data-size="60"><a href="{{url('site/aboutus')}}">About US</a>
                                </li>
                                    ...
                                    <ul class="sub-menu">
                                        <li class="menu-item menu-item-has-children"><a href="blog-full-right-sidebar-with-frame.html" class="sf-with-ul-pre">Blog Full</a>
                                            <ul class="sub-menu">
                                                ...
                                                <li class="menu-item"><a href="blog-full-left-sidebar-with-frame.html">Blog
                                                        Full Left Sidebar With Frame</a></li>
                                                <li class="menu-item"><a href="blog-full-both-sidebar-with-frame.html">Blog
                                ...
                                {{-- <li class="menu-item menu-item-has-children" data-size="60"><a href="portfolio-3-columns.html" class="sf-with-ul-pre">Portfolio</a>
                                    <ul class="sub-menu">
                                        ...
                                        <li class="menu-item menu-item-has-children"><a class="sf-with-ul-pre" href="singleportfolio.html">Single
                                                Portfolio</a></li>
                                    </ul>
                                </li> --}}
                                <li class="menu-item" data-size="60"><a href="{{url('site/gallery')}}">Gallery</a></li>
                                ...
                                <li class="menu-item" data-size="60"><a href="{{url('site/coming_soon')}}">Coming
                                        Soon</a></li>
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li class="menu-item" data-size="15">
                                        <div class="kingster-mega-menu-section-content">
                                            ...
                                            <span id="span_fd84_0">Academic offerings include 95 majors, 86
                                                minors, and more than 100 in-major specializations</span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="menu-item menu-item-has-children kingster-normal-menu"><a href="apply-to-kingster.html" class="sf-with-ul-pre">Admissions</a>
                            <ul class="sub-menu">
                                {{-- <li class="menu-item" data-size="60"><a href="apply-to-kingster.html">Apply
                                        To Kingster</a></li> --}}
                                <li class="menu-item" data-size="60"><a href="{{url('site/camppus_tour')}}">Campus
                                        Tour</a></li>
                        ...
                        <li class="menu-item menu-item-has-children kingster-normal-menu"><a href="#" class="sf-with-ul-pre">Courses</a>
                            <ul class="sub-menu">
                                <li class="menu-item" data-size="60"><a href="{{url('site/course_list')}}">Course
                                        List </a></li>
                                <li class="menu-item" data-size="60"><a href="{{url('site/courselist1')}}">Course
                                        List </a></li>
                            </ul>
                        </li>
                        {{-- <li class="menu-item kingster-normal-menu"><a href="athletics.html">Athletics</a>
                        </li> --}}
                    <li class="menu-item kingster-normal-menu"><a href="{{url('site/universitylife')}}">University
                                Life</a></li>
                    </ul>
...
<footer>
                ...
                <div class="kingster-footer-container kingster-container clearfix">
                    <div class="kingster-footer-column kingster-item-pdlr kingster-column-15">
                        <div id="text-2" class="widget widget_text kingster-widget">
                            <div class="textwidget logo-size">
                                <p><img src="{{asset('camppus_assets\images\logo.png')}}" alt="" />
                                    <br />
                                    <span class="fa-2x kingster-widget-title">Camppus</span>
                                ...
                                <p><span id="span_1dd7_11">+1-2534-4456-345</span>
                                    ...
                                    <br /> <a id="a_1dd7_8" href="mailto:camppusportal19@gmail.com">Click to mail us</a></p>
                        ...
                        <div id="gdlr-core-custom-menu-widget-2" class="widget widget_gdlr-core-custom-menu-widget kingster-widget">
                            ...
                            <div class="menu-our-campus-container">
                                <ul id="menu-our-campus" class="gdlr-core-custom-menu-widget gdlr-core-menu-style-plain">
                                    <li class="menu-item"><a href="{{url('site/')}}">Home</a></li>
                                    <li class="menu-item"><a href="{{url('site/aboutus')}}">About Us</a></li>
                                    <li class="menu-item"><a href="{{url('site/contact')}}">Get in touch</a></li>
                        ...
                        <div id="gdlr-core-custom-menu-widget-3" class="widget widget_gdlr-core-custom-menu-widget kingster-widget">
                            ...
                            <div class="menu-campus-life-container">
                                <ul id="menu-campus-life" class="gdlr-core-custom-menu-widget gdlr-core-menu-style-plain">
                                    ...
                                    <li class="menu-item"><a href="{{url('site/universitylife')}}">University Life</a></li>
                                    <li class="menu-item"><a href="{{url('site/camppus_tour')}}">Camppus Tour</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="kingster-copyright-wrapper">
                <div class="kingster-copyright-container kingster-container clearfix">
                    {{-- <div class="kingster-copyright-left kingster-item-pdlr">Copyright All Right Reserved 2019, Max Themes
                    </div> --}}
...
{{-- Scripts --}}
<script type='text/javascript' src='{{asset('camppus_assets/js/jquery/jquery.js')}}'></script>

<script type='text/javascript' src='{{asset('camppus_assets/js/jquery/jquery-migrate.min.js')}}'></script>

<script type='text/javascript' src='{{asset('camppus_assets/plugins/revslider/public/assets/js/jquery.themepunch.tools.min.js')}}'></script>

<script type='text/javascript' src='{{asset('camppus_assets/plugins/revslider/public/assets/js/jquery.themepunch.revolution.min.js')}}'></script>

<script type="text/javascript" src="{{asset('camppus_assets/plugins/revslider/public/assets/js/extensions/revolution.extension.slideanims.min.js')}}"></script>
<script type="text/javascript" src="{{asset('camppus_assets/plugins/revslider/public/assets/js/extensions/revolution.extension.layeranimation.min.js')}}"></script>
<script type="text/javascript" src="{{asset('camppus_assets/plugins/revslider/public/assets/js/extensions/revolution.extension.kenburn.min.js')}}"></script>

<script type="text/javascript" src="{{asset('camppus_assets/plugins/revslider/public/assets/js/extensions/revolution.extension.navigation.min.js')}}"></script>

<script type="text/javascript" src="{{asset('camppus_assets/plugins/revslider/public/assets/js/extensions/revolution.extension.parallax.min.js')}}"></script>

<script type="text/javascript" src="{{asset('camppus_assets/plugins/revslider/public/assets/js/extensions/revolution.extension.actions.min.js')}}"></script>

<script type="text/javascript" src="{{asset('camppus_assets/plugins/revslider/public/assets/js/extensions/revolution.extension.video.min.js')}}"></script>
...
<script type='text/javascript' src='{{asset('camppus_assets/plugins/goodlayers-core/plugins/combine/script.js')}}'></script>
<script type='text/javascript'>
    var gdlr_core_pbf = {
        "admin": "",
        "video": {
...
<script type='text/javascript' src='{{asset('camppus_assets/plugins/goodlayers-core/include/js/page-builder.js')}}'></script>

<script type='text/javascript' src='{{asset('camppus_assets/js/jquery/ui/effect.min.js')}}'></script>
<script type='text/javascript'>
    var kingster_script_core = {
        "home_url": "https:\/\/demo.goodlayers.com\/kingster\/"
    };
</script>
<script type='text/javascript' src='{{asset('camppus_assets/js/plugins.min.js')}}'></script>
<script>
    /*<![CDATA[*/
